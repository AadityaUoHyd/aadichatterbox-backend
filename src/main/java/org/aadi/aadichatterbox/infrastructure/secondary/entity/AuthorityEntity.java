...
import org.aadi.aadichatterbox.messaging.domain.user.aggregate.AuthorityBuilder;
...
public class AuthorityEntity {
    ...
    public static Set<AuthorityEntity> from(Set<Authority> authorities) {
        return authorities
                .stream()
                .map(authority ->
                        org.aadi.aadichatterbox.infrastructure.secondary.entity.AuthorityEntityBuilder.authorityEntity()
